...
const Signup = require("../models/signupModel"); // Sequelize User model
const Password = require("../models/passwordModel"); // Sequelize Password model

// Reset Password Form 
const resetPasswordForm = async (req, res) => {
  try {
    const { email } = req.query; // frontend should pass email as query param
...
// ================= Reset Password Submit (dummy) =================
const resetPasswordSubmit = async (req, res) => {
  try {
    // Still dummy: just respond success without updating anything
    res.json({
      success: true,
      message: "Password reset successfully! (dummy)",
      redirect: "/home.html",
    });
  } catch (err) {
